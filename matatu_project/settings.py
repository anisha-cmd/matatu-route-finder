"""
Django settings for matatu_project project.
...
SECRET_KEY = 'django-insecure-sc(%6gk37e_=0lps=9dy%!n%t1c4s1n&33u0lb&t+g!tw(j7$d'
...
ROOT_URLCONF = 'matatu_project.urls'
...
WSGI_APPLICATION = 'matatu_project.wsgi.application'
